...
| `apps/ios` | Apple adapters, route/GPS orchestration, composition root, user interaction | Protocol duplication |
| `apps/band` | Vela lifecycle, envelope v1 peer, route-card PNG and native marker UI | Xiaomi BLE framing |
