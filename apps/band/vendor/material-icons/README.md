...
The roundabout_right artwork is retained only as historical source. Navigation now uses the neutral numbered symbol documented in ../mapbox-directions/README.md, because a generic roundabout instruction does not specify a right turn.
