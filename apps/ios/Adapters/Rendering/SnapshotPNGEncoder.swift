...
enum SnapshotPNGEncoder {
    ...
    private static func palette(for profile: SnapshotPaletteProfile) -> [(UInt8, UInt8, UInt8)] {
        ...
        let compact: [(UInt8, UInt8, UInt8)] = [
            (5, 14, 22), (16, 28, 35), (28, 43, 50), (40, 52, 63),
            (37, 48, 74), (22, 61, 43), (0, 79, 110), (34, 48, 71),
            (47, 64, 87), (70, 90, 116), (96, 115, 143), (216, 214, 194),
            (255, 255, 255), (47, 107, 255), (65, 81, 107), (102, 255, 122),
        ]
