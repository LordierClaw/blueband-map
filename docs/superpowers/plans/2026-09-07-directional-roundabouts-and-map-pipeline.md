...
Final verification: source 5e948c7; test-only follow-ups through ff43da0. Canonical make test/lint/diff checks pass, portable Swift 181 and Band 36 tests pass; iOS CI 34250292153 passes 90 tests including overlap, stale GPS, stop, reroute and timeout recovery. Renderers, accepted map/HUD geometry and Xiaomi bytes are unchanged. See docs/testing/handoffs/directional-roundabouts-and-map-pipeline.md for source/artifact identity and physical-device acceptance boundaries.
