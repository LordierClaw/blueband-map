...
| RPK debug | Có | `artifacts/m1/5e7ff51/dev.lordierclaw.bluebandmap.band.debug.0.2.0.rpk` | 18488 | `1b368fc44fb9b9ffca30bfe12bb7f4b35b87155e8376e7ac3c7d18e4c72fa31f` |
...
RPK trên dùng đúng file của bundle này. `aiot-toolkit 2.0.5` chèn build timestamp, ZIP timestamp và chữ ký mới vào mỗi lần build, nên rebuild cùng source commit có thể tạo SHA-256/byte size khác; luôn đối chiếu file được bàn giao với `SHA256SUMS`, không dùng hash của một lần build khác.
